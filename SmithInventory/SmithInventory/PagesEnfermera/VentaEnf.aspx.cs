    ...
    public partial class VentaEnf : System.Web.UI.Page
    {
        ...
        private void CalcularTotalVenta()
        {
            ...
            foreach (GridViewRow fila in gvProductosVenta.Rows)
            {
                ...
                int subtotalIndex = gvProductosVenta.Columns.Cast<DataControlField>()
                                       .ToList()
                ...
                using (var scope = new TransactionScope())
                {
                    using (var db = new DCSmithDataContext(Global.CADENA))
                    {
                        ...
                        var nuevaVenta = new DB.Venta
                        {
                            ...
                            id_Usuario = Convert.ToInt16(Session["id_Usuario"]), // Aquí debes reemplazarlo con la lógica para obtener el ID de usuario
                            id_Estado = 1
                        };
